      ...
      <Base>
        <SobreWrapper>
            ...
            <div>
              ...
              <p>Para colaborar com o acervo basta clicar no botão <Link to="/novo_filme" target="_blank">“Adicione um filme”</Link> e preencher as informações necessárias, simples assim! Quem constrói este acervo é você!</p>
              ...
              <p>O Paranáflix não tem finalidade lucrativa, mantemos o site através de doações, caso queira contribuir acesse <a href="https://apoia.se/paranaflix" target="_blank">nossa campanha no Apoia.se</a></p>
            ...
            <div>
              ...
              <p>• <a href="http://www.instagram.com/paranaflix" target="_blank">Siga o Paranáflix no Instagram</a>.</p>
